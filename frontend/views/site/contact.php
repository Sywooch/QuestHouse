...
<div class="container">
    <div class="post-inner" style="background: rgba(54, 25, 25, .2); padding: 15px;">
    <div class="row">
        <div class="col-md-7" style="color:#ffffff;">
            ...
            <form class="mt30">
                ...
                <input class="btn" style="background-color: #5b84aa; " type="submit" value="Send Message" />
            </form>
        </div>
        <div class="col-md-4">
            <aside class="sidebar-right">
                <ul class="address-list list" style="color:#ffffff;">
                    <li>
                        <h5 style="color:#ffffff;">Email</h5><a href="#">info@traveler.com</a>
                    </li>
                    <li>
                        <h5 style="color:#ffffff;">Phone Number</h5><a href="#">+1 (426) 642-8525</a>
                    </li>
                    <li>
                        <h5 style="color:#ffffff;">Skype</h5><a href="#">contact_traveller</a>
                    </li>
                    <li>
