                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <form action="#" class="well">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="u-name">
                                    Details
                                </label>
        ...
        <div class="row-fluid">
            ...
            <div class="span6">
                <div class="widget">
                  ...
                  <textarea class="input-block-level no-margin" placeholder="Textarea" style="height: 112px">
                  </textarea>
                    </div>
                </div>
            </div>
        ...
        <div class="row-fluid hidden-phone">
            <div class="span6">
                <div class="widget no-margin">
                    <div class="widget-header">
                        <div class="title">
                            <span class="fs1" aria-hidden="true" data-icon="&#xe04d;"></span> Time Picker
                        </div>
                    </div>
                    <div class="widget-body">
            ...
            <div class="span6">
                <div class="widget no-margin">
                    <div class="widget-header">
                        <div class="title">
                            <span class="fs1" aria-hidden="true" data-icon="&#xe052;"></span> Date picker
                        </div>
                    </div>
                    <div class="widget-body">
                        <form class="form-horizontal" action="#">
