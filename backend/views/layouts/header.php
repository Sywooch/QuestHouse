        ...
        <ul class="hidden-phone">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu pull-right">
                    ...
                    <li class="quick-messages">
                        <img src="images/avatar-2.png" class="avatar" alt="Avatar">
                        <div class="message-date text-info">
                            <i>02 <span class="month">mins</span></i>
                        </div>
                        <div class="message-wrapper">
                    ...
                    <li class="quick-messages">
                        <img src="images/avatar-5.png" class="avatar" alt="Avatar">
                        <div class="message-date text-info">
                    ...
                    <li class="quick-messages">
                        <img src="images/avatar-4.png" class="avatar" alt="Avatar">
                        <div class="message-date text-info">
                    ...
                    <li class="quick-messages">
                        <img src="images/avatar-6.png" class="avatar" alt="Avatar">
                        <div class="message-date text-info">
